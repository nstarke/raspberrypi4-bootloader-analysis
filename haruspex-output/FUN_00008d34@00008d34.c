...
undefined4 FUN_00008d34(undefined4 param_1,undefined4 *param_2,int param_3)

{
  ...
  uVar8 = extraout_r5;
  if (uVar2 != 0) {
    FUN_0000e198((byte *)s_SDRAM_CONFIG___02x_00008ee4,uVar2,extraout_r2,extraout_r3,extraout_r4,
                 extraout_r5);
  ...
  if ((uVar10 != 0) && (uVar10 != *(uint *)(unaff_gp + 0x88))) {
    FUN_0000e198((byte *)s_SDRAM__OTP_config_mismatch_expec_00008f5c,uVar10,
  ...
  *(uint *)(unaff_gp + 0x2cd0) = uVar10;
  ...
  FUN_0000e198((byte *)s_Initialising_SDRAM_rank__d_total_00008f9c,uVar5,uVar10,uVar3,uVar4,uVar2);
  ...
  if (uVar10 != 0x18) {
    ...
    if ((int)uVar10 < 0x19) {
      ...
      if ((int)uVar10 < 0x41) {
        if (uVar10 != 0x20) {
LAB_00008e26:
          _write_to_stderr((byte *)s_Unsupported_memory_size___d_00008f14,uVar10,iVar6,iVar7,
  ...
  if (param_2 != (undefined4 *)0x0) {
    ...
    for (; param_2 + 0x2b < puVar9; param_2 = param_2 + uVar4 + 0x2b) {
      ...
      {
        FUN_0000e198((byte *)s_DDR__d__d__d__d__d_BL__d_00008ef8,param_2[2],param_2[4],param_2[5],
                     param_2[3],uVar4);
        bVar1 = true;
    ...
    uVar2 = FUN_00008120(param_1);
    _write_to_stderr((byte *)s_MCB__d_size_gbit__d_dual_rank__d_00008f30,uVar2,extraout_r2_00,
