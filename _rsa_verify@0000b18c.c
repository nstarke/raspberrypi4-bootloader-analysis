...
int _rsa_verify(int *input_data_1,int *input_data_2,int *input_data_3,undefined4 context_param_4,
...

{
  ...
  FUN_0000e198((byte *)s_RSA_verify_0000b21c,(uint)input_data_2,input_data_3,context_param_4,
  ...
  if (input_data_2[2] == 0x100) {
    ...
    if (key_length == 0x108) {
      ...
      _write_to_stderr((byte *)s_rsa_verify__s__0x_x__0000b228,global_counter,-key_length,
  ...
  _write_to_stderr((byte *)error_message,input_data_2[2],extraout_r2_02,extraout_r3_02,key_length,
                   extraout_r5_02);
  return -1;
}
